...
export default function DashboardHeader() {
    ...
    return (
      <div className="grid grid-cols-5 gap-10">
        {Array.from({ length: 5 }).map((_, index) => (
          <div key={index} className="p-4 rounded-sm shadow-lg h-24 flex flex-col justify-between">
  ...
  return (
    <div className="grid grid-cols-5 gap-10">
      ...
      <div className="p-4 rounded-sm shadow-lg h-24 flex flex-col justify-between">
        <h2 className="text font-semibold text-muted-foreground">Total Race</h2>
